...
listen_for_commands: 
    ...
    while command_go = 0 ' while no "$Gxxx" command received, execute the few "immediate commands" but otherwise, return to wait for further instructions
        ...
        if command[0] = 57 then
            dot_counter_point = command_value ' drop_fwd_cor 8
        ...
        if command[0] = 84 then ' how much to open/close chute           T
        ...
        if command[0] = 85 then ' how much to open/close chute           U
