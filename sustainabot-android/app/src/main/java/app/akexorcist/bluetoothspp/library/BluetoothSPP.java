...
public class BluetoothSPP {
	...
	public interface OnDataReceivedListener {
		...
		void onLineEndReceived(String message);
	}
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				...
				case BluetoothState.MESSAGE_DEVICE_NAME:
					...
					isConnected = true;
					break;
				case BluetoothState.MESSAGE_LINE_END:
					if (mDataReceivedListener != null) {
						String line = (String) msg.obj;
						if (!TextUtils.isEmpty(line)) {
							mDataReceivedListener.onLineEndReceived(line);
						}
					}
					break;
	...
	public void connect(Intent data) {
		...
		Log.d("BluetoothSPP", "Connecting to " + address);
		BluetoothDevice device = mBluetoothAdapter.getRemoteDevice(address);
		Log.d("BluetoothSPP", "Device: " + device.getName() + ", " + device.getAddress());
	...
	public void disconnect() {
		if (mBluetoothService != null) {
			...
			if (mBluetoothService.getState() == BluetoothState.STATE_NONE) {
				isServiceRunning = true;
				mBluetoothService.start(BluetoothSPP.this.isAndroid);
			}
		}
	}
	...
	public void send(String data, boolean CRLF) {
		if (mBluetoothService.getState() == BluetoothState.STATE_CONNECTED) {
			...
			// Log.d("BluetoothSPP", "sent: " + data + " , " + data.getBytes());
		}
	}
